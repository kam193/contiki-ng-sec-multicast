...
<simconf>
  ...
  <simulation>
    ...
    <motetype>
      org.contikios.cooja.contikimote.ContikiMoteType
      <identifier>mtype380</identifier>
    ...
    <mote>
      ...
      <motetype_identifier>mtype380</motetype_identifier>
    </mote>
    <mote>
      <interface_config>
        org.contikios.cooja.interfaces.Position
...
Receiver (4) has a certificate signed by another CA.
Sender (2) sends secured group message to receivers (3, 4),
but (4) will not get a group key and will drop the messages.</notes>
