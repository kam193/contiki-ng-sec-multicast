...
<simconf>
  ...
  <simulation>
    ...
    <motetype>
      ...
      <source>[CONTIKI_DIR]/tests/21-secure-multicast/code-simulations-tests/08-none-mode/root.c</source>
    ...
    <motetype>
      ...
      <source>[CONTIKI_DIR]/tests/21-secure-multicast/code-simulations-tests/02-secured-messages/stranger.c</source>
      <commands>make stranger.cooja TARGET=cooja</commands>
      <moteinterface>org.contikios.cooja.interfaces.Position</moteinterface>
      <moteinterface>org.contikios.cooja.interfaces.Battery</moteinterface>
      <moteinterface>org.contikios.cooja.contikimote.interfaces.ContikiVib</moteinterface>
      <moteinterface>org.contikios.cooja.contikimote.interfaces.ContikiMoteID</moteinterface>
    ...
    <mote>
      <interface_config>
        ...
        <x>46.90721940502037</x>
        <y>28.391940691137695</y>
        <z>0.0</z>
      </interface_config>
      <interface_config>
    ...
    <mote>
      <interface_config>
        org.contikios.cooja.interfaces.Position
        <x>27.467276509023677</x>
        <y>65.56384869543243</y>
        <z>0.0</z>
      </interface_config>
      <interface_config>
        org.contikios.cooja.contikimote.interfaces.ContikiMoteID
    ...
    <mote>
      <interface_config>
        org.contikios.cooja.interfaces.Position
        <x>-16.926023580439768</x>
        <y>76.06735686123842</y>
        <z>0.0</z>
      </interface_config>
      <interface_config>
        org.contikios.cooja.contikimote.interfaces.ContikiMoteID
    ...
    <mote>
      <interface_config>
        org.contikios.cooja.interfaces.Position
        <x>51.853322711238526</x>
        <y>101.27811971334508</y>
        <z>0.0</z>
      </interface_config>
      <interface_config>
        org.contikios.cooja.contikimote.interfaces.ContikiMoteID
    ...
    <mote>
      <interface_config>
        org.contikios.cooja.interfaces.Position
        <x>9.513937947467635</x>
        <y>104.60283826452842</y>
        <z>0.0</z>
      </interface_config>
      <interface_config>
        org.contikios.cooja.contikimote.interfaces.ContikiMoteID
  ...
  <plugin>
    ...
    <plugin_config>
      ...
      <viewport>2.497436715308646 0.0 0.0 2.497436715308646 153.87366295395373 -43.8982367170744</viewport>
    </plugin_config>
    <width>400</width>
    <z>4</z>
    <height>400</height>
...
Receiver (5) is a stranger.
Sender (2) sends secured group message to receivers (3, 4, 5),
but (5) cannot read it.</notes>
  ...
  <plugin>
    ...
    <plugin_config>
      <scriptfile>[CONTIKI_DIR]/tests/21-secure-multicast/js/08-none-mode.js</scriptfile>
      <active>true</active>
    </plugin_config>
    <width>799</width>
    <z>0</z>
