...
<simconf>
  ...
  <simulation>
    ...
    <motetype>
      ...
      <source>[CONTIKI_DIR]/tests/21-secure-multicast/code-simulations-tests/09-default-action/root.c</source>
  ...
  <plugin>
    ...
    <plugin_config>
      ...
      <viewport>1.7651281606734213 0.0 0.0 1.7651281606734213 151.28286954354635 52.4461547305596</viewport>
    </plugin_config>
    <width>400</width>
    <z>4</z>
    <height>400</height>
...
Root has no configured secured group, but it's configured
with default action as using no encryption.
Sender (2) sends secured group message to receivers (3, 4).</notes>
  ...
  <plugin>
    ...
    <plugin_config>
      <scriptfile>[CONTIKI_DIR]/tests/21-secure-multicast/js/09-default-action.js</scriptfile>
      <active>true</active>
    </plugin_config>
    <width>799</width>
    <z>3</z>
