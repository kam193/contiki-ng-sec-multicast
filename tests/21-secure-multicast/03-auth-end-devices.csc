...
<simconf>
  ...
  <simulation>
    ...
    <mote>
      <interface_config>
        org.contikios.cooja.interfaces.Position
        <x>31.76759976015603</x>
        <y>109.02339371951096</y>
        <z>0.0</z>
      </interface_config>
      <interface_config>
        org.contikios.cooja.contikimote.interfaces.ContikiMoteID
  ...
  <plugin>
    ...
    <plugin_config>
      ...
      <viewport>2.68039403702137 0.0 0.0 2.68039403702137 132.74593792801912 -23.314084437763082</viewport>
    </plugin_config>
    <width>400</width>
    <z>4</z>
    <height>400</height>
...
but (4) will not get a group key and will drop the messages.</notes>
  ...
  <plugin>
    ...
    <plugin_config>
      <scriptfile>[CONTIKI_DIR]/tests/21-secure-multicast/js/03-auth-end-devices.js</scriptfile>
      <active>true</active>
    </plugin_config>
    <width>799</width>
    <z>3</z>
