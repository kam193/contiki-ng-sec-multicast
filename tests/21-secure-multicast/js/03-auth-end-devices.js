...
var root = ["Root initialized"];

var receiver = ["Joined multicast group ff1e::89:a00d", "Got: this_is_test"];

var receiver_wrong_cert = [
  "Joined multicast group ff1e::89:a00d",
  "Set alternative certificate",
  "Timeout expired.",
];

var sender = ["Sending message to ff1e::89:a00d", "[DONE]"];

var expected_mgs = {
  1: root,
  2: sender,
  3: receiver,
  4: receiver_wrong_cert,
};
