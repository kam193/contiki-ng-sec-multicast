...
struct sec_certificate cert = {{{ 0x0, 0x0 } }, SEC_MODE_AES_CBC, (SEC_FLAG_DECRYPT & SEC_FLAG_ENCRYPT), &sec_desc};

struct secure_descriptor sec_desc_2 = { "ddddaaaaddddaaaa", "1234123412341234" };
struct sec_certificate cert_2 = {{{ 0x0, 0x0 } }, SEC_MODE_AES_CBC, (SEC_FLAG_DECRYPT & SEC_FLAG_ENCRYPT), &sec_desc_2};
